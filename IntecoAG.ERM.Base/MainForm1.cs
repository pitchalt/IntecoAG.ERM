...
namespace IntecoAG.ERM.Module {
    public partial class MainForm1 : MainFormTemplateBase, IDockManagerHolder, ISupportMdiContainer, ISupportClassicToRibbonTransform {
        ...
        public MainForm1(XafApplication application) : this() {
        }
        public MainForm1() {
            InitializeComponent();
            InitializeImages();
