...
namespace IntecoAG.ERM.FM.ReportHelper {
    ...
    [VisibleInReports]
    [Persistent("fmRHUnpayedRequestContractLine")]
    //[DefaultProperty("OrganizationName")]
    public class fmCRHUnpayedRequestContractLine : csCComponent
    {
        public fmCRHUnpayedRequestContractLine(Session session)
            : base(session) {
        }

        public override void AfterConstruction() {
            base.AfterConstruction();
            this.ComponentType = typeof(fmCRHUnpayedRequestContractLine);
        ...
        private String _OrganizationComment;   // Сборка примечаний для организации

        private fmCRHUnpayedRequest _UnpayedRequest;   // Заголовочная запись
        ...
        /// <summary>
        /// Сборка примечаний для организации
        /// </summary>
        public String OrganizationComment {
            get {
                return _OrganizationComment;
            }
            set {
                SetPropertyValue<String>("OrganizationComment", ref _OrganizationComment, value);
            }
        }
        ...
        /// Заголовочная запись
        /// </summary>
        //[Association("fmCRHUnpayedRequest-fmCRHUnpayedRequestContractLine")]
