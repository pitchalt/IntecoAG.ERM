...
namespace IntecoAG.ERM.CRM.Counters {
    ...
    public class RegistrationLogDocNumberGenerator : XPLiteObject {

        public RegistrationLogDocNumberGenerator(Session session)
            : base(session) {
        }
        
        public RegistrationLogDocNumberGenerator(Session session, int year, hrmDepartment department)
            : base(session) {
                Year = year;
