namespace IntecoAG.ERM.FM.Tax.RuVat {
    partial class ОснованиеVC {
        ...
        private void InitializeComponent() {
            ...
            this.ImportAction.Id = "FmTaxRuVatОснованиеVC_ImportAction";
            ...
            this.ImportAction.TargetViewType = DevExpress.ExpressApp.ViewType.ListView;
            this.ImportAction.ToolTip = null;
            this.ImportAction.TypeOfView = typeof(DevExpress.ExpressApp.ListView);
            this.ImportAction.Execute += new DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler(this.ImportAction_Execute);
            // 
            // ОснованиеVC
            // 
            this.TargetObjectType = typeof(IntecoAG.ERM.FM.Tax.RuVat.Основание);
