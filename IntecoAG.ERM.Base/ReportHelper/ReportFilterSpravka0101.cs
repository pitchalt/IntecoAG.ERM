...
namespace IntecoAG.ERM.Module.ReportHelper {
    [NonPersistent]
    public class ReportFilterSpravka0101 : BaseReportFilter //ReportParametersObjectBase, ICustomFilter
    {
        public ReportFilterSpravka0101(Session session) : base(session) { }
