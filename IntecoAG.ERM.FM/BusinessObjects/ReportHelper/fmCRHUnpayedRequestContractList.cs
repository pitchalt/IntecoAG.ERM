...
namespace IntecoAG.ERM.FM.ReportHelper {
    ...
    [NonPersistent]
    public class fmCRHUnpayedRequestContractList : BaseObject
    {
        public fmCRHUnpayedRequestContractList(Session session)
            : base(session) {
        }
        ...
        /// Заголовочная запись
        /// </summary>
        //[Association("fmCRHUnpayedRequestNonPersistent-fmCRHUnpayedRequestContractList")]
