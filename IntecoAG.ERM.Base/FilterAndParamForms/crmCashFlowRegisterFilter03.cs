...
namespace IntecoAG.ERM.Module {
    [NonPersistent]
    public class crmCashFlowRegisterFilter03 : ReportParametersObjectBase, ICustomFilter
    {
        public crmCashFlowRegisterFilter03(Session session) : base(session) { }
        ...
        private fmSubject _Subject;
        [Custom("Caption", "Тема")]
        public fmSubject Subject {
            get { return _Subject; }
            set { SetPropertyValue<fmSubject>("Subject", ref _Subject, value); }
        }
        // END
