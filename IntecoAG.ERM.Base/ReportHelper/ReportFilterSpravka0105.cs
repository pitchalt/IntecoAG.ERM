...
namespace IntecoAG.ERM.Module.ReportHelper {
    [NonPersistent]
    public class ReportFilterSpravka0105 : BaseReportFilter //ReportParametersObjectBase, ICustomFilter
    {
        public ReportFilterSpravka0105(Session session) : base(session) { }
