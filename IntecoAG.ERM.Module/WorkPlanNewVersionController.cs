...
namespace IntecoAG.ERM.Module {
    public partial class WorkPlanNewVersionController : ViewController {
        public WorkPlanNewVersionController() {
            InitializeComponent();
        ...
        private void SimpleContractNewVersion_Execute(object sender, SimpleActionExecuteEventArgs e) {
            ...
            WorkPlan currentObj = (WorkPlan)View.CurrentObject;
            WorkPlanVersion newVers = currentObj.CreateNewVersion();
            View.ObjectSpace.CommitChanges();

            // Показываем этот новый объект
            ShowConcreteDetailView<WorkPlanVersion>("WorkPlanVersion_DetailView", newVers);
        }
