...
namespace IntecoAG.ERM.Module {
    ...
    public class crmPlaneFactRegisterFilter01 : ReportParametersObjectBase, ICustomFilter {
        ...
        /*
                ...
                protected Quarter _Quarter;
                [Custom("Caption", "Квартал")]
                public Quarter Quarter {
                    get { return _Quarter; }
                    set { SetPropertyValue<Quarter>("Quarter", ref _Quarter, value); }
                }
        ...
        */
        ...
        [Custom("Caption", "Кредитор")]
        public crmCParty Creditor {
            get { return _Creditor; }
            set {
                SetPropertyValue<crmCParty>("Creditor", ref _Creditor, value);
            }
        }

        private crmCParty _Debitor;
        [Custom("Caption", "Дебитор")]
        public crmCParty Debitor {
            get { return _Debitor; }
            set {
                SetPropertyValue<crmCParty>("Debitor", ref _Debitor, value);
            }
        }
        ...
        protected csNomenclature _Nomenclature;
        [Custom("Caption", "Номенклатура")]
        //[Custom("Caption", (false) ? "Регистрир. сотр." : "WWWWWWWWWWWWWWWW")]
        ...
        */
        ...
        private CriteriaOperator SearchCriteriaObjectBuilder() {
            ...
            */
            ...
            if (this.Nomenclature != null) {
                criteriaNomenclature = new BinaryOperator("Nomenclature.Oid", Nomenclature.Oid, BinaryOperatorType.Equal);
                ((GroupOperator)criteriaCustomerAND).Operands.Add(criteriaNomenclature);
            }
        ...
        public void ClearFilter() {
            ...
            //this.MonthBegin = 0;
            //this.MonthEnd = 0;
            this.ObligationUnit = null;
            //this.PaymentPriceFrom = 0;
            //this.PaymentPriceTo = 0;
            //this.PaymentValuta = null;
            //this.PriceFrom = 0;
            //this.PriceTo = 0;
            this.Creditor = null;
            //this.Quarter = 0;
