...
namespace IntecoAG.ERM.Module {
    ...
    //[NavigationItem(true)]
    [Persistent("AdminFilteringCriterion")]
    public class AdminFilteringCriterion : BaseObject, ICustomFilter
    {

        public AdminFilteringCriterion(Session session) : base(session) { }
