...
namespace IntecoAG.ERM.Module {
    ...
    public class crmPlaneFactRegisterFilter01 : ReportParametersObjectBase, ICustomFilter
    {
        ...
        [Custom("Caption", "Единица измерения")]
        ...
        [Custom("Caption", "Стоимость в валюте договора от")]
        ...
        [Custom("Caption", "Стоимость в валюте договора до")]
        ...
        [Custom("Caption", "Стоимость договора руб. от")]
        ...
        [Custom("Caption", "Стоимость договора руб. до")]
        ...
        [Custom("Caption", "Объем в натуральном выражении от")]
        ...
        [Custom("Caption", "Объем в натуральном выражении до")]
