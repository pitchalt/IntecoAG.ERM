...
namespace IntecoAG.ERM.CRM.Contract.Deal {
    ...
    [NonPersistent]
    public class crmDealRegistrationStatistics: LinqQuery<crmDealRegistrationStatistics, crmContractDeal>   { 
//        public crmDealRegistrationStatistics() {}
        public crmDealRegistrationStatistics(Session ses): base(ses) { }
        
        public crmDealRegistrationStatistics(Session ses, hrmStaff staff, Int32 count): base(ses) {
            this._Staff = staff;
