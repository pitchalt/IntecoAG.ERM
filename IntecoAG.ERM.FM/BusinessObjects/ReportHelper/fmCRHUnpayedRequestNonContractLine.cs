...
namespace IntecoAG.ERM.FM.ReportHelper {
    ...
    [VisibleInReports]
    [Persistent("fmRHUnpayedRequestNonContractLine")]
    //[DefaultProperty("OrganizationName")]
    public class fmCRHUnpayedRequestNonContractLine : csCComponent
    {
        public fmCRHUnpayedRequestNonContractLine(Session session)
            : base(session) {
        }

        public override void AfterConstruction() {
            base.AfterConstruction();
            this.ComponentType = typeof(fmCRHUnpayedRequestNonContractLine);
        ...
        /// Заголовочная запись
        /// </summary>
        //[Association("fmCRHUnpayedRequest-fmCRHUnpayedRequestNonContractLine")]
