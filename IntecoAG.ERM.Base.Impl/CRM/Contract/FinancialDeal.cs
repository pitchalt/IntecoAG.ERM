...
namespace IntecoAG.ERM.CRM.Contract
{
    ...
    //})]
    //[DefaultClassOptions]
    [Persistent("crmFinancialDeal")]
    //[MapInheritance(MapInheritanceType.ParentTable)]
    public partial class crmFinancialDeal : BaseObject //, IContractDealFactory, IVersionBusinessLogicSupport, IVersionMainObject
    {
        public crmFinancialDeal(Session ses) : base(ses) { }

        public override void AfterConstruction() {
            base.AfterConstruction();

            this.Current = new crmFinancialDealVersion(this.Session, VersionStates.VERSION_NEW);
            this.FinancialDealVersions.Add(this.Current);
        }
        ...
        private crmFinancialDealVersion _Current;
        [Aggregated]
        [ExpandObjectMembers(ExpandObjectMembers.InDetailView)]
        public crmFinancialDealVersion Current {
            get { return _Current; }
            set { SetPropertyValue<crmFinancialDealVersion>("Current", ref _Current, value); }
        }
