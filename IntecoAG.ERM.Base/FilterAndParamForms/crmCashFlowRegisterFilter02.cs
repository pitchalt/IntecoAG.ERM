...
namespace IntecoAG.ERM.Module {
    [NonPersistent]
    public class crmCashFlowRegisterFilter02 : ReportParametersObjectBase, ICustomFilter
    {
        public crmCashFlowRegisterFilter02(Session session) : base(session) { }
