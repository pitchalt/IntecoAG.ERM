...
namespace IntecoAG.ERM.Module.ReportHelper {
    [NonPersistent]
    public class ReportFilterSpravka0103 : BaseReportFilter //ReportParametersObjectBase, ICustomFilter
    {
        public ReportFilterSpravka0103(Session session) : base(session) { }
