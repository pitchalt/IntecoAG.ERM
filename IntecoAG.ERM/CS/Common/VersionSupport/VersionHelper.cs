...
namespace IntecoAG.ERM.CS {
    ...
    public class VersionHelper {
        ...
        /// слоя типа ComplexContractVersion)
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public Dictionary<IVersionSupport, IVersionSupport> GenerateCopyOfObjects(List<IVersionSupport> list, Session ssn, IVersionSupport sourceObj) {
...
// Паша
                ...
                foreach (XPMemberInfo m in sourceClassInfo.PersistentProperties) {
                    ...
                    if (ob != null && dict.ContainsKey(ob)) {
                        ...
                        if (newValue != null) m.SetValue(targetObject, newValue);
                    }
                }
