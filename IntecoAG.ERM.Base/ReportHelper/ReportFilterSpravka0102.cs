...
namespace IntecoAG.ERM.Module.ReportHelper {
    [NonPersistent]
    public class ReportFilterSpravka0102 : BaseReportFilter //ReportParametersObjectBase, ICustomFilter
    {
        public ReportFilterSpravka0102(Session session) : base(session) { }
