...
{
    public partial class ERMWinFormsApplication : WinApplication
    {
        public ERMWinFormsApplication() {
            InitializeComponent();
            DelayedViewItemsInitialization = true;

            // SHU 2011-12-08 Регистрация собственного провайдера для PostgeSql (чтобы Like заменить на ILike)
